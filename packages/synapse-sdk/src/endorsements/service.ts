...
export class EndorsementsService {
  ...
  private _endorsedProviderIds: number[] | null = null

  private constructor(provider: ethers.Provider, endorsementsAddress: string) {
