...
describe('SPRegistryService', () => {
  ...
  beforeEach(() => {
    ...
    service = new SPRegistryService(provider, 314159, ADDRESSES.calibration.spRegistry)
  })

  describe('Constructor', () => {
    it('should create instance with provider and address', () => {
      server.use(JSONRPC(presets.basic))
      const instance = new SPRegistryService(provider, 314159, ADDRESSES.calibration.spRegistry)
