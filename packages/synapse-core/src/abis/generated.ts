...
export const errorsAbi = [
    {
        type: 'error',
        inputs: [{ name: 'field', internalType: 'enum Errors.AddressField', type: 'uint8' }],
    ...
    {
        type: 'error',
        inputs: [{ name: 'clientDataSetId', internalType: 'uint256', type: 'uint256' }],
        name: 'ClientDataSetAlreadyRegistered',
    },
    {
        type: 'error',
        inputs: [
            { name: 'commissionType', internalType: 'enum Errors.CommissionType', type: 'uint8' },
    ...
    },
    {
        type: 'error',
        inputs: [
            { name: 'productType', internalType: 'enum ServiceProviderRegistryStorage.ProductType', type: 'uint8' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'minimumLockupRequired', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'requiredLockupPeriod', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        type: 'error',
        inputs: [
            { name: 'priceType', internalType: 'enum Errors.PriceType', type: 'uint8' },
            { name: 'maxAllowed', internalType: 'uint256', type: 'uint256' },
            { name: 'actual', internalType: 'uint256', type: 'uint256' },
        ],
...
export const filecoinPayV1Abi = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 's', internalType: 'bytes32', type: 'bytes32' },
            { name: 'operator', internalType: 'address', type: 'address' },
            { name: 'rateAllowanceIncrease', internalType: 'uint256', type: 'uint256' },
            { name: 'lockupAllowanceIncrease', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'lockupCurrent', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'lockupRate', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'lockupLastSettledAt', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'token', internalType: 'contract IERC20', type: 'address', indexed: true },
            { name: 'client', internalType: 'address', type: 'address', indexed: true },
            { name: 'operator', internalType: 'address', type: 'address', indexed: true },
            { name: 'approved', internalType: 'bool', type: 'bool', indexed: false },
            { name: 'rateAllowance', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'lockupAllowance', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'maxLockupPeriod', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'railId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'payer', internalType: 'address', type: 'address', indexed: true },
            { name: 'payee', internalType: 'address', type: 'address', indexed: true },
            { name: 'token', internalType: 'contract IERC20', type: 'address', indexed: false },
            { name: 'operator', internalType: 'address', type: 'address', indexed: false },
            { name: 'validator', internalType: 'address', type: 'address', indexed: false },
            { name: 'serviceFeeRecipient', internalType: 'address', type: 'address', indexed: false },
            { name: 'commissionRateBps', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'RailCreated',
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [{ name: 'railId', internalType: 'uint256', type: 'uint256', indexed: true }],
        name: 'RailFinalized',
    },
    {
        type: 'event',
        ...
        inputs: [
            { name: 'railId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'oldLockupPeriod', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'newLockupPeriod', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'oldLockupFixed', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'newLockupFixed', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'railId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'netPayeeAmount', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'operatorCommission', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'networkFee', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'railId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'totalSettledAmount', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'totalNetPayeeAmount', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'operatorCommission', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'networkFee', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'settledUpTo', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'RailSettled',
    },
    {
        ...
        inputs: [
            ...
            { name: 'endEpoch', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'RailTerminated',
    },
    {
    ...
    },
    {
        type: 'error',
        inputs: [
            { name: 'nextRateChangeUntilEpoch', internalType: 'uint256', type: 'uint256' },
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'attemptedLockupFixed', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'attemptedLockupPeriod', internalType: 'uint256', type: 'uint256' },
        ],
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x09a0fDc2723fAd1A7b8e3e00eE5DF73841df55a0)
 */
export const filecoinPayV1Config = { address: filecoinPayV1Address, abi: filecoinPayV1Abi } as const
...
export const filecoinWarmStorageServiceAbi = [
    {
        ...
        inputs: [
            ...
            { name: '_paymentsContractAddress', internalType: 'address', type: 'address' },
            { name: '_usdfc', internalType: 'contract IERC20Metadata', type: 'address' },
            { name: '_filBeamBeneficiaryAddress', internalType: 'address', type: 'address' },
            { name: '_serviceProviderRegistry', internalType: 'contract ServiceProviderRegistry', type: 'address' },
            { name: '_sessionKeyRegistry', internalType: 'contract SessionKeyRegistry', type: 'address' },
        ],
        stateMutability: 'nonpayable',
    },
    {
    ...
    },
    {
        ...
        outputs: [{ name: 'storageRate', internalType: 'uint256', type: 'uint256' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
        inputs: [
            ...
            { name: '_challengeWindowSize', internalType: 'uint256', type: 'uint256' },
        ],
        ...
        outputs: [
            {
                ...
                type: 'tuple',
                components: [
                    { name: 'pricePerTiBPerMonthNoCDN', internalType: 'uint256', type: 'uint256' },
                    { name: 'pricePerTiBCdnEgress', internalType: 'uint256', type: 'uint256' },
                    { name: 'pricePerTiBCacheMissEgress', internalType: 'uint256', type: 'uint256' },
                    { name: 'tokenAddress', internalType: 'contract IERC20', type: 'address' },
                    { name: 'epochsPerMonth', internalType: 'uint256', type: 'uint256' },
                    { name: 'minimumPricePerMonth', internalType: 'uint256', type: 'uint256' },
                ],
            },
        ],
        stateMutability: 'view',
    },
    {
        ...
        inputs: [
            { name: '_maxProvingPeriod', internalType: 'uint64', type: 'uint64' },
            { name: '_challengeWindowSize', internalType: 'uint256', type: 'uint256' },
            { name: '_filBeamControllerAddress', internalType: 'address', type: 'address' },
    ...
    { type: 'function', inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable' },
    {
        ...
        outputs: [{ name: '', internalType: 'contract ServiceProviderRegistry', type: 'address' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
        ...
        outputs: [{ name: '', internalType: 'contract SessionKeyRegistry', type: 'address' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'cacheMissAmountToAdd', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'cdnAmountAdded', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'totalCdnLockup', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'cacheMissAmountAdded', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'totalCacheMissLockup', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'endEpoch', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'cacheMissRailId', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'cdnRailId', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'providerId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'pdpRailId', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'cacheMissRailId', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'cdnRailId', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'payer', internalType: 'address', type: 'address', indexed: false },
            { name: 'serviceProvider', internalType: 'address', type: 'address', indexed: false },
            { name: 'payee', internalType: 'address', type: 'address', indexed: false },
            { name: 'metadataKeys', internalType: 'string[]', type: 'string[]', indexed: false },
            { name: 'metadataValues', internalType: 'string[]', type: 'string[]', indexed: false },
        ],
        name: 'DataSetCreated',
    },
    {
        ...
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'oldServiceProvider', internalType: 'address', type: 'address', indexed: true },
            { name: 'newServiceProvider', internalType: 'address', type: 'address', indexed: true },
        ],
    ...
    { type: 'event', anonymous: false, inputs: [], name: 'EIP712DomainChanged' },
    {
        ...
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'periodsFaulted', internalType: 'uint256', type: 'uint256', indexed: false },
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'oldController', internalType: 'address', type: 'address', indexed: false },
            { name: 'newController', internalType: 'address', type: 'address', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'keys', internalType: 'string[]', type: 'string[]', indexed: false },
            { name: 'values', internalType: 'string[]', type: 'string[]', indexed: false },
        ],
        name: 'PieceAdded',
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'storagePrice', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'minimumRate', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'PricingUpdated',
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [{ name: 'providerId', internalType: 'uint256', type: 'uint256', indexed: true }],
    ...
    },
    {
        ...
        inputs: [
            { name: 'dataSetId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'railId', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'newRate', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [{ name: 'viewContract', internalType: 'address', type: 'address', indexed: true }],
...
export const filecoinWarmStorageServiceStateViewAbi = [
    {
        type: 'constructor',
        inputs: [{ name: '_service', internalType: 'contract FilecoinWarmStorageService', type: 'address' }],
        stateMutability: 'nonpayable',
    },
    {
        type: 'function',
    ...
    },
    {
        ...
        outputs: [{ name: 'status', internalType: 'enum FilecoinWarmStorageService.DataSetStatus', type: 'uint8' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
    ...
    },
    {
        ...
        outputs: [
            ...
            { name: 'initChallengeWindowStart', internalType: 'uint256', type: 'uint256' },
        ],
        stateMutability: 'view',
    },
    {
    ...
    },
    {
        ...
        inputs: [],
        name: 'service',
        outputs: [{ name: '', internalType: 'contract FilecoinWarmStorageService', type: 'address' }],
        stateMutability: 'view',
    },
    {
        type: 'function',
...
export const pdpVerifierAbi = [
    ...
    { type: 'function', inputs: [], name: 'migrate', outputs: [], stateMutability: 'nonpayable' },
    {
        type: 'function',
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256' },
    ...
    {
        type: 'function',
        inputs: [{ name: 'newFeePerTiB', internalType: 'uint256', type: 'uint256' }],
        name: 'updateProofFee',
        outputs: [],
        stateMutability: 'nonpayable',
    },
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'storageProvider', internalType: 'address', type: 'address', indexed: true },
        ],
        name: 'DataSetCreated',
    },
    {
        ...
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'deletedLeafCount', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'DataSetDeleted',
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [{ name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true }],
        name: 'DataSetEmpty',
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [
            { name: 'currentFee', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'newFee', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'effectiveTime', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'challengeEpoch', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'leafCount', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'NextProvingPeriod',
    },
    {
    ...
    },
    {
        ...
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'pieceIds', internalType: 'uint256[]', type: 'uint256[]', indexed: false },
            {
                name: 'pieceCids',
                internalType: 'struct Cids.Cid[]',
                type: 'tuple[]',
    ...
    },
    {
        ...
        inputs: [
            { name: 'setId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'oldStorageProvider', internalType: 'address', type: 'address', indexed: true },
            { name: 'newStorageProvider', internalType: 'address', type: 'address', indexed: true },
        ],
        name: 'StorageProviderChanged',
    },
    {
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x85e366Cf9DD2c0aE37E963d9556F5f4718d6417C)
 */
export const pdpVerifierConfig = { address: pdpVerifierAddress, abi: pdpVerifierAbi } as const
...
export const serviceProviderRegistryAbi = [
        ...
        outputs: [
            {
                ...
                components: [
                    ...
                    { name: 'productCapabilityValues', internalType: 'bytes[]', type: 'bytes[]' },
                ],
            },
        ],
        stateMutability: 'view',
    ...
    {
        type: 'function',
        inputs: [{ name: 'providerIds', internalType: 'uint256[]', type: 'uint256[]' }],
    ...
    { type: 'function', inputs: [], name: 'removeProvider', outputs: [], stateMutability: 'nonpayable' },
    { type: 'function', inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable' },
    {
        type: 'function',
        inputs: [{ name: 'newOwner', internalType: 'address', type: 'address' }],
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'serviceProvider', internalType: 'address', type: 'address', indexed: false },
            { name: 'capabilityKeys', internalType: 'string[]', type: 'string[]', indexed: false },
            { name: 'capabilityValues', internalType: 'bytes[]', type: 'bytes[]', indexed: false },
        ],
        name: 'ProductAdded',
    },
    {
    ...
    },
    {
        ...
        inputs: [
            { name: 'providerId', internalType: 'uint256', type: 'uint256', indexed: true },
            { name: 'serviceProvider', internalType: 'address', type: 'address', indexed: true },
            { name: 'payee', internalType: 'address', type: 'address', indexed: true },
        ],
...
export const sessionKeyRegistryAbi = [
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'identity', internalType: 'address', type: 'address', indexed: true },
            { name: 'signer', internalType: 'address', type: 'address', indexed: false },
            { name: 'expiry', internalType: 'uint256', type: 'uint256', indexed: false },
            { name: 'permissions', internalType: 'bytes32[]', type: 'bytes32[]', indexed: false },
            { name: 'origin', internalType: 'string', type: 'string', indexed: false },
        ],
 ...
 * - [__View Contract on Filecoin Calibration Filscan__](https://calibration.filscan.io/address/0x518411c2062E119Aaf7A8B12A2eDf9a939347655)
 */
export const sessionKeyRegistryConfig = { address: sessionKeyRegistryAddress, abi: sessionKeyRegistryAbi } as const
