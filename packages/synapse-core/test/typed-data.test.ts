...
const FIXTURES = {
  ...
  signatures: {
    ...
    addPieces: {
      extraData:
        '' as Hex,
      clientDataSetId: 12345n,
      nonce: 1n,
    },
    ...
    terminateService: {
      extraData:
        '' as Hex,
      dataSetId: 67890n,
    },
  },
}
...
describe('Typed Data', () => {
  ...
  it('should sign terminate service', async () => {
    const extraDataActual = await TypedData.signTerminateService(client, {
      dataSetId: FIXTURES.signatures.terminateService.dataSetId,
    })

    assert.strictEqual(
      extraDataActual,
      FIXTURES.signatures.terminateService.extraData,
      'TerminateService extraData should match Solidity reference'
    )
  })
