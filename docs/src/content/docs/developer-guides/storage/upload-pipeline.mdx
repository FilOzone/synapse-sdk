...
The default is 2 copies. The first copy is stored on an [**endorsed** provider](/core-concepts/storage-providers#endorsed-providers) (high trust, curated), and secondary copies are pulled via SP-to-SP transfer from [approved providers](/core-concepts/storage-providers#approved-providers).
