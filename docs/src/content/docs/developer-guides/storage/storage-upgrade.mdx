...
The SDK splits compatible concurrent uploads according to the encoded Filecoin message-size budget. Legacy data sets additionally have an **80-piece safety cap**. You can start uploads together without manually grouping them.
:::
