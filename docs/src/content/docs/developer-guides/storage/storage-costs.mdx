...
:::tip[How It Works]
For a deep understanding of the payment model — account state, payment rails, rate mechanics, and deposit calculation — see the [Payments & Storage cookbook](/cookbooks/payments-and-storage/).
:::
