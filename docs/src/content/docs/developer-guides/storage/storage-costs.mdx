...
console.log("Rate per epoch:", costs.rate.perEpoch)
console.log("Rate per month:", formatUnits(costs.rate.perMonth))
console.log("Deposit needed:", formatUnits(costs.depositNeeded))
console.log("Needs FWSS approval:", costs.needsFwssMaxApproval)
console.log("Ready to upload:", costs.ready)
```
