...
- **Traffic:** 1,000 users × 500 MiB/month ≈ 500,000 MiB/month egress

```ts twoslash
const STORAGE_PRICE_PER_TIB_PER_MONTH = 2.5; // $2.50/TiB/month
const CDN_EGRESS_PRICE_PER_TIB = 7.0; // $7/TiB downloaded
const storageMiB = 100_000;
const egressMiB = 500_000;

// Storage: 100,000 MiB ≈ 0.0953 TiB
const storageTiB = storageMiB / 1024 / 1024;

// Egress: 500,000 MiB ≈ 0.476 TiB
...
// Egress cost per month: 0.476 TiB × $7 ≈ $3.332/month
const egressCostPerMonth = egressTiB * CDN_EGRESS_PRICE_PER_TIB;

// Total cost per month: $0.238/month + $3.332/month ≈ $3.57/month
const totalCostPerMonth = storageCostPerMonth + egressCostPerMonth;

// Total cost for 24 months: $3.57/month × 24 ≈ $85.68
...
| CDN Egress     | ≈ 3.332 USDFC    | ≈ 79.97 USDFC     |
| **Total**      | **≈ 3.57 USDFC** | **≈ 85.68 USDFC** |
