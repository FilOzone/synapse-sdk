...
- **`PDPVerifier`** - Client for PDPVerifier contract - get dataset and piece status, create data sets and add pieces
...
The PaymentsService provides direct access to the FilecoinPay contract, enabling you to:
