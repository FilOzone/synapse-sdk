...
1) Set the environment variable `SYNAPSE_TELEMETRY_DISABLED=true` before instantiating Synapse.

2) Set `globalThis.SYNAPSE_TELEMETRY_DISABLED=true` before instantiating Synapse.
