...
- **[Get Started](/getting-started/)** - Quick start guide to integrate the Synapse SDK into your application
- **[Core Concepts](/core-concepts/architecture/)** - Understand the architecture, PDP, and FilecoinPay protocols
- **[Developer Guides](/developer-guides)** - Comprehensive guides for storage, payments, and monitoring

**Learn More:**

- [About FOC Architecture](/introduction/about-filecoin-onchain-cloud/) - Deep dive into the four fundamental layers
- [Architecture Overview](/core-concepts/architecture/) - How all components work together
- [Example Application](https://github.com/FIL-Builders/fs-upload-dapp) - Full-stack reference implementation
