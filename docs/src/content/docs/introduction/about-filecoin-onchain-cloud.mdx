...
Since its launch, [**Filecoin Network**](https://filecoin.io/) has been the backbone for **decentralized data storage**, anchored by its _Proof-of-Replication (PoRep)_ model that ensures the integrity of long-term, immutable data. However, as decentralized applications evolve, they demand **faster access, dynamic payments, and cryptographic verification** that can operate within smart contracts.
...
- **[Why Choose FOC?](/introduction/why-filecoin-onchain-cloud/)** - Understand the value proposition and use cases
- **[Get Started](/getting-started/)** - Begin implementing with the Synapse SDK
- **[Core Concepts](/core-concepts/architecture/)** - Deep dive into the architecture and protocols
- **[Developer Guide](/developer-guides/)** - Learn how to build on FOC using Synapse SDK.

**Related Topics:**

- [PDP Protocol](/core-concepts/pdp-overview/) - How proof-of-data-possession works
- [Filecoin Pay](/core-concepts/filecoin-pay-overview/) - Understanding the payment settlement layer
- [Filecoin Warm Storage Service](/core-concepts/fwss-overview/) - The warm storage layer of the Filecoin Onchain Cloud
