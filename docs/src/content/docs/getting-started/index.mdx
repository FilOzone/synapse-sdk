...
- [Session Keys](/developer-guides/access-control/session-keys/) - Delegate signing to ephemeral keys for better UX
- [Programmable ACLs](/developer-guides/access-control/programmable-acls/) - Rich delegation of dataset control to a smart contract
