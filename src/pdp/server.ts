...
export class PDPServer {
  ...
  async createDataSet (
    ...
    const response = await fetch(`${this._apiEndpoint}/pdp/data-sets`, {
      method: 'POST',
      headers: {
  ...
  async addPieces (
    ...
    const response = await fetch(`${this._apiEndpoint}/pdp/data-sets/${dataSetId}/pieces`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  async getDataSetCreationStatus (txHash: string): Promise<DataSetCreationStatusResponse> {
    const response = await fetch(`${this._apiEndpoint}/pdp/data-sets/created/${txHash}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  async getPieceAdditionStatus (
    ...
    const response = await fetch(
      `${this._apiEndpoint}/pdp/data-sets/${dataSetId}/pieces/added/${txHash}`,
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
  ...
  async getDataSet (dataSetId: number): Promise<DataSetData> {
    const response = await fetch(`${this._apiEndpoint}/pdp/data-sets/${dataSetId}`, {
      method: 'GET',
      headers: {
