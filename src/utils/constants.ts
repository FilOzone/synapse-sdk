...
export const CONTRACT_ADDRESSES = {
  ...
  /**
   * Warm Storage View contract addresses
   * This contract contains read-only view methods separated from the main Warm Storage contract
   */
  WARM_STORAGE_VIEW: {
    mainnet: '', // TODO: Get actual mainnet address from deployment
    calibration: '0x0000000000000000000000000000000000000001' // Placeholder - awaiting deployment
  } as const satisfies Record<FilecoinNetworkType, string>
} as const
